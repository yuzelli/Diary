...
import com.example.yuzelli.diary.adapter.GuideViewAdapter;
...
public class GuideActivity extends BaseActivity {
    ...
    // 图片
    private int[] imageView = { R.drawable.common_guide_1, R.drawable.common_guide_2,
            R.drawable.common_guide_3, R.drawable.common_guide_4, R.drawable.common_guide_5 ,R.drawable.common_guide_6};
    ...
    private void initoper() {
        ...
        tv_immediatelyEnter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                editor.commit();
                Intent intent = new Intent(GuideActivity.this,LockActivity.class);
